...
<html>
  <head>
    ...
    <link rel="stylesheet" type="text/css" href= "<?php echo base_url();?>css/ionicons/css/ionicons.css"/>
        ...
        <div class="row">
                ...
                <div class="col-md-6 col-xs-12 text-xs-center">
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-3 col-xs-6 text-xs-center">
                            <a href="#nextModal" data-toggle="modal" data-target="#nextModal"><i class="icon-lg ion-ios-pie-outline wow fadeIn text-primary"></i>
                        </div>
                        <div class="col-lg-3 col-md-3 col-xs-6 text-xs-center">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-body">
                ...
                <p class="text-xs-center"><a href="http://bootstrap4.guide">Download at Bootstrap4.guide</a></p>
                <br>
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <div class="modal-body">
                ...
                <p class="text-xs-center"><a href="https://medium.com/@bootply/bootstrap-4-whats-new-visual-guide-c84dd81d8387">Learn More</a></p>
                <br>
...
<div id="nextModal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
